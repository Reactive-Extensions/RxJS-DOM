# RxJS Lite DOM Events Module #

This project provides Reactive Extensions for JavaScript (RxJS) bindings for HTML DOM objects to abstract over the event binding using RxJS Lite.  

## Details ##

Files:
- [`rx.lite.dom.events.js`](https://github.com/Reactive-Extensions/RxJS-DOM/blob/master/modules/lite-events/rx.lite.dom.events.js)

NPM Packages:
- [`rx-lite-dom-events`](https://www.npmjs.com/package/rx-lite-dom-events)
